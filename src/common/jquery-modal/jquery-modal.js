...
(function (factory) {
  ...
  $.modal.prototype = {
    ...
    open() {
      ...
      $(document).off('keydown.modal').on('keydown.modal', (event) => {
        const current = getCurrent();
    ...
    _ctx() {
      return {
        elm: this.$elm, $elm: this.$elm, $blocker: this.$blocker, options: this.options, $anchor: this.anchor,
      };
    },
  };
